...
- Updated OpenTelemetry to
  [v1.16.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.16.0).

## v1.15.0

- Updated OpenTelemetry to
  [v1.15.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.15.0).

## v1.14.0

- Updated OpenTelemetry to
  [v1.14.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.14.0).

## v1.13.0

- Updated OpenTelemetry to
  [v1.13.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.13.0).
...
- Updated OpenTelemetry to
  ...
  has **known issues** with exporting metrics so stay on v1.9.0 if you are affected.
...
- Updated OpenTelemetry to
  [v1.8.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.8.0).

## v1.7.0

- Updated OpenTelemetry to
  [v1.7.0](https://github.com/open-telemetry/opentelemetry-go/releases/tag/v1.7.0).
...
See [documentation](https://uptrace.dev/get/opentelemetry-go.html#resource-detectors) for details.
